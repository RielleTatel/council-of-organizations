...
export function RecWeekCta() {
  return (
    <section className="relative overflow-hidden bg-trust-blue py-24 md:py-28">
      ...
      <EmbroideredAccent color="yellow" index={0} size={64} className="absolute bottom-10 right-10 opacity-70" />
      ...
      <Reveal className="mx-auto flex max-w-[800px] flex-col items-center gap-6 px-6 text-center">
        ...
        <p className="max-w-[60ch] font-body text-lg leading-relaxed text-linen-white/85">
          Discover organizations that match your interests, build lifelong friendships, and develop your
          leadership potential through COA-Z.
        </p>
        <Link
          to="/organizations"
